...
# Environment setup
# os.environ["CUDA_VISIBLE_DEVICES"] = "9"  # Commented out - set via environment or command line
...
def train_process(augmentation=False, straug_N=3, epochs=EPOCHS, wandb_project="trocr-straug", 
                 wandb_name=None, run_name=None):
    """
    Training function with STRAug support
    ...
    # WandB config with STRAug parameters
    config = {
        ...
        "straug_N": straug_N if augmentation else None,
        "device": device,
    ...
    wandb.log({
        ...
        "dataset/straug_N": straug_N if augmentation else None
    })
    ...
    wandb.log({
        ...
        "final/straug_N": straug_N if augmentation else None
    }, step=epoch)
...
if __name__ == '__main__':
    ...
    print("=== Training STRAug (N=2 groups) ===")
    best_res, run_name = train_process(
        augmentation=True,
        straug_N=2,
        epochs=50,
        wandb_project="trocr-straug",
        wandb_name="STRAug-N2",
        run_name="STRAug-N2"
    )